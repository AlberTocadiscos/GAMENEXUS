...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-06-2024 a las 12:28:23
...
(3, 12, 'Manolo Lama De Ubrique', 0, 'Mi casa, al lado de la panaderia de jose', '28941', 'El Rabal', 'AW', 'Barcelona', '897898765'),
(4, 12, 'SISISISISIISISI', 1, 'Mi casa, al lado de la panaderia de jose', '28941', 'El Rabal', 'AW', 'Barcelona', '897898765');
...
(10, '4677836556798789', '823', '12/24', 'Yo', 12, 1),
(11, '5555555555555555', '821', '12/24', 'Yo', 12, 0);
...
CREATE TABLE `features` (
  ...
  `min_req` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `max_req` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `game_price` decimal(5,2) UNSIGNED NOT NULL,
  `game_discount` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `game_valoration` decimal(2,1) UNSIGNED NOT NULL,
  `game_pegi` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 2, '2024-04-14', 39.90, 2, 2, 9),
(2, 2, '2024-04-14', 100.00, 2, 11, 9),
(3, 2, '2024-04-14', 69.98, 2, 12, 9),
(4, 12, '2024-06-03', 39.94, 3, 15, 11);
...
(1, 1, 2, 9.0, 'Minecraft es pura creatividad en bloques, nunca deja de sorprenderme lo que se puede construir', '2024-04-08 22:00:35'),
(1, 1, 3, 7.0, 'Genial para jugar con amigos, pero después de un tiempo se puede sentir repetitivo', '2024-04-09 14:00:40'),
(1, 1, 4, 9.5, 'La sensación de aventura y exploración es incomparable, cada mundo es una nueva historia', '2024-04-10 00:00:00'),
(1, 1, 5, 8.5, 'Los gráficos son simples pero eso es parte de su encanto, es como jugar con Legos digitales', '2024-04-10 00:00:00'),
(1, 1, 6, 9.0, 'El modo supervivencia puede volverse un reto increíblemente adictivo, ¡cuidado con los creepers!', '2024-04-10 00:00:00'),
(1, 1, 7, 0.5, 'No sé cómo jugar', '2024-04-10 00:00:00'),
(1, 1, 12, 9.0, 'Me ha gustado mucho', '2024-06-03 16:17:19'),
(3, 3, 2, 2.0, 'La idea de los bucles temporales es interesante, pero el juego se vuelve frustrante y repetitivo demasiado rápido', '2024-04-12 00:00:00'),
(5, 6, 2, 7.3, 'Sniper Elite 5 tiene momentos de satisfacción con sus disparos a larga distancia, pero la inteligencia artificial deja mucho que desear.', '2024-04-14 22:18:17'),
(6, 3, 3, 3.5, 'Deathloop es un lío confuso de mecánicas y narrativa, y me aburrí antes de terminar el primer bucle', '2024-04-10 00:00:00'),
(6, 3, 4, 4.3, 'Prometía mucho, pero la jugabilidad repetitiva y la falta de innovación me decepcionaron totalmente.', '2024-04-10 00:00:00'),
(6, 14, 2, 9.0, 'Modern Warfare redefine los shooters con su realismo brutal y una campaña que te deja sin aliento, un imprescindible para los fans del género', '2024-04-14 22:17:42');
...
(11, 'manoloLama', 'angelgordonmadrid@gmail.com', '$2y$13$Nck7osFrH.jO.xp3rNaMbe.yg.9CLWKjEpmp1Tt7/YETpSj02VuIG', 'default', 'ROLE_USER', 'ACTIVE', 33),
(12, 'manoloLama2', 'mipadre@gmail.com', '$2y$13$2Svf5VSNZCsEzOrkQ3J/GO8XA2Qq5oDsGb.1dRKAqJL/bA6dP1Yq2', 'default', 'ROLE_USER', 'ACTIVE', 34);
...
--
ALTER TABLE `billing`
  MODIFY `id_billing` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `card`
--
ALTER TABLE `card`
  MODIFY `id_card` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `games`
  MODIFY `id_game` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `wishlist`
  MODIFY `id_wishlist` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
ALTER TABLE `cart_products`
  ...
  ADD CONSTRAINT `FK22` FOREIGN KEY (`id_game`) REFERENCES `games` (`id_game`) ON UPDATE CASCADE,
...
--
ALTER TABLE `games_platform`
  ADD CONSTRAINT `FK20` FOREIGN KEY (`id_feature`) REFERENCES `features` (`id_feature`) ON UPDATE CASCADE,
...
--
ALTER TABLE `media_games`
  ADD CONSTRAINT `FK23` FOREIGN KEY (`id_media`) REFERENCES `media` (`id_media`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FK24` FOREIGN KEY (`id_platform`) REFERENCES `platforms` (`id_platform`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FK25` FOREIGN KEY (`id_game`) REFERENCES `games` (`id_game`) ON UPDATE CASCADE;
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `FK34` FOREIGN KEY (`id_card`) REFERENCES `card` (`id_card`) ON UPDATE CASCADE;
